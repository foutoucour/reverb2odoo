...
description: Use when writing, reviewing, or formatting Python code. Covers formatting rules, logging with loguru, pathlib for file paths, pytest conventions, dependency pinning, and uv tooling.
---

# Python Coding Standards

Follow [PEP 8](https://peps.python.org/pep-0008/) as the baseline. The rules below refine or extend it for this project.
...
Every module and function must have corresponding unit tests. Use `pytest`. Place tests in `tests/` mirroring the source structure.
